...
import RadioTilesField, { IRadioTilesField } from './RadioTilesField';

export default {
  title: 'Atoms/RadioTilesField',
  component: RadioTilesField,
};

export const Base: Story<IRadioTilesField> = (args) => {
  return <RadioTilesField {...args} />;
};
